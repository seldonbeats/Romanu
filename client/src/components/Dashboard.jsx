...
import { DashboardDrumSample, DashboardNewDrumSample, DashboardNewSong } from ".";
...
import DashboarDrumSample from "./DashboardDrumSample";
import DashboarNewDrumSample from "./DashboardNewDrumSample";
    ...
    <div className="w-full h-auto flex flex-col items-center justify-center bg-primary">
      ...
      <div className="w-[60%] my-2 p-4 flex items-center justify-evenly">
        ...
        <NavLink to={"/dashboard/albums"} className={({ isActive }) => isActive ? isActiveStyles : isNotActiveStyles }> Albums </NavLink>
         {/* prettier-ignore */}
         <NavLink to={"/dashboard/DrumkitLoopkit"} className={({ isActive }) => isActive ? isActiveStyles : isNotActiveStyles }> DrumKit - LoopKit </NavLink>
      </div>
      ...
      <div className="my-4 w-full p-4">
        <Routes>
          ...
          <Route path="/newDrumkitLoopkit" element={<DashboardNewDrumSample />} />
          <Route path="/DrumkitLoopkit" element={<DashboardDrumSample />} />
